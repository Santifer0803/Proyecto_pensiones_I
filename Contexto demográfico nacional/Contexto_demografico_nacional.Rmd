...
#se filtran los años 
migracion.total <- migracion.total[migracion.total$Año >= 2000 & migracion.total$Año <= 2024, ]
...
```{r}
tasas_anualizadas <- read_excel("C:/Users/Admin/Downloads/tasas_anualizadas.xlsx")

ggplot(tasas_anualizadas, aes(x = Año, y = `Tasa Anual Promediada`)) +
  geom_line(color = "firebrick") +
  geom_point(color = "red") +
  labs(title = "Tasa Desempleo en Costa Rica (2000-2024)",
       x = "Año",
       y = "Tasa de Desempleo",
       caption = "Elaboración propia") +
  theme_minimal()
