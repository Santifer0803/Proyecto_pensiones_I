...
A continuacion se crean dos vectores para hombres y mujeres donde se identifica si al momento de la muerte era mayor a 25 (TRUE) lo que implica que tiene un hijo. 
```{r}
hijos.h <- mapply(function(i, j) {
  edades.h[i, j] >= 25
}, i = filas.muerte.h, j = col.fallecido.h)

hijos.m <- mapply(function(i, j) {
  edades.m[i, j] >= 25
