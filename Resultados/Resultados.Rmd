...
pensiones <- append(pensiones, matrices.pension)
}
...
for (i in 1:ncol(matriz.pasivo)) {
  matriz.pasivo[, i] <-
    c((sum(pensiones[[i]][[1]] * matriz.vp) + sum(pensiones[[i]][[2]] * matriz.vp)),
      (sum(pensiones[[i]][[3]] * matriz.vp) + sum(pensiones[[i]][[4]] * matriz.vp)),
      (sum(pensiones[[i]][[5]] * matriz.vp) + sum(pensiones[[i]][[6]] * matriz.vp)),
      (sum(pensiones[[i]][[7]] * matriz.vp) + sum(pensiones[[i]][[8]] * matriz.vp)),
      (sum(pensiones[[i]][[9]] * matriz.vp) + sum(pensiones[[i]][[10]] * matriz.vp)),
      (sum(pensiones[[i]][[11]] * matriz.vp) + sum(pensiones[[i]][[12]] * matriz.vp)))
}
