...
while(abs(prom.despues - prom.antes >= 0.1)){
...
matriz.aleatoria.m <- matrix(runif(nrow(cotizantes.m) * ncol(mortm.m)), 
...
for(i in 1:ncol(salarios.finales)){
  ...
  costo.pens <- sum(Reduce("+", lapply(matrices.pension, function(mat) mat[, i])))
