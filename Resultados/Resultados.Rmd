...
edad.vejinv.h <- 2024 - year(pension.vejinv.h$fec_nac)
...
edad.vejinv.m <- 2024 - year(pension.vejinv.m$fec_nac)
...
edad.suc.ch <- 2024 - year(pension.suc.ch$fec_nac)
...
edad.suc.hh <- 2024 - year(pension.suc.hh$fec_nac)
...
edad.suc.cm <- 2024 - year(pension.suc.cm$fec_nac)
...
edad.suc.hm <- 2024 - year(pension.suc.hm$fec_nac)
...
# Se crea una lista con las 6 matrices principales calculadas
