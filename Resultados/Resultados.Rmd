...
estados.h <-
  ifelse(lista.estados.h[[2]] == 1,
         ...
         ifelse(
           lista.estados.h[[1]] == 1,
           "Invalido",
           ifelse(((postergacion.simulada.h == 1) * (cotizaciones.acum.h > 179) * (edades.h > 65)
           ) == 1,
           "Posterga",
           ifelse(((((cotizaciones.acum.h > 179) * (edades.h > 65)
           ) == 0) * (actividad.h == 1)) == 1,
           "Activo",
           ifelse(((((cotizaciones.acum.h > 179) * (edades.h > 65)
           ) == 0) * (actividad.h == 0)) == 1, "Inactivo", ifelse(
...
estados.m <-
  ifelse(lista.estados.m[[2]] == 1,
         ...
         ifelse(
           lista.estados.m[[1]] == 1,
           "Invalido",
           ifelse(((postergacion.simulada.m == 1) * (cotizaciones.acum.m > 404) * (edades.m == 64)
           ) == 1,
           "Posterga",
           ifelse(((postergacion.simulada.m == 1) * (cotizaciones.acum.m > 356) * (edades.m == 65)
           ) == 1,
           "Posterga",
           ifelse(((postergacion.simulada.m == 1) * (cotizaciones.acum.m > 179) * (edades.m > 65)
           ) == 1,
           "Posterga",
           ifelse(
             ((edades.m == 64) * (cotizaciones.acum.m > 404)) == 1,
             "Retirado",
             ifelse(((edades.m == 65) * (cotizaciones.acum.m > 356)
             ) == 1, "Retirado", ifelse(((edades.m > 65) * (cotizaciones.acum.m > 179)) == 1,
                                        "Retirado",
                                        ifelse(actividad.m == 1, "Activo", "Inactivo")
             ))
           ))
