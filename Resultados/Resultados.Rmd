...
bono_cotizaciones <- 0.000833        # que excedan las 300 cotizaciones
bono_postergacion <- 0.001333         #por mes de postergacion
limite.postergacion <- 1.25
```
