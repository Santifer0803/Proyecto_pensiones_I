...
library(readxl)
data_tasa_basica <- read_excel("C:/Users/Admin/Downloads/historico_tasa_basica_pasiva_mensual.xlsx")
```
...
```{r}
library(tidyverse)  # Carga dplyr y ggplot2
...
```
De este pequeño resumen, podemos observar que los primeros años no estamos teniendo una consistencia de los datos, esto se debe
