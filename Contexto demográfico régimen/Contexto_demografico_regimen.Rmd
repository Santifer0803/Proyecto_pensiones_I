...
for (i in 1:(364 - 328 - 12)) {
  ...
  lista.trab[[i]] <- rowSums(cotizantes[, (328 + i):(339 + i)] > 10000)
}
...
ggplot(trabajadores, aes(x = meses)) +
  geom_line(aes(y = activos, color = "Activo")) +
  geom_line(aes(y = inactivos, color = "Inactivo")) +
  labs(x = "Tiempo", y = "Cantidad de trabajadores") +
  scale_colour_manual(name = "Estado", values = c("Activo" = "steelblue1", "Inactivo" = "tan2")) +
  theme_minimal()
```
